...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SingleSelector = __webpack_require__(152);

	var _SingleSelector2 = _interopRequireDefault(_SingleSelector);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_SingleSelector2.default.el = '#root'; // 单选页面
	exports.default = new Vue(_SingleSelector2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/violetjack/Documents/WorkSpace/mobilenurseweex/src/views/SingleSelector.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	if (Component.options.functional) {console.error("[vue-loader] SingleSelector.vue: functional components are not supported with templates, they should use render functions.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-743a5874", Component.options)
	  } else {
	    hotAPI.reload("data-v-743a5874", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(5)("672d556c", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../node_modules/.0.26.4@css-loader/index.js!../../node_modules/.10.3.0@vue-loader/lib/style-rewriter.js?id=data-v-743a5874&scoped=true!../../node_modules/.10.3.0@vue-loader/lib/selector.js?type=styles&index=0!./SingleSelector.vue", function() {
	     var newContent = require("!!../../node_modules/.0.26.4@css-loader/index.js!../../node_modules/.10.3.0@vue-loader/lib/style-rewriter.js?id=data-v-743a5874&scoped=true!../../node_modules/.10.3.0@vue-loader/lib/selector.js?type=styles&index=0!./SingleSelector.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }), _vm._v(" "), _vm._l((_vm.parseOptions(_vm.DataObj.text)), function(item, index) {
	    return _c('SelectorItem', {
	      key: index,
	      attrs: {
	        "value": item,
	        "isChecked": _vm.parseOptions(_vm.DataObj.option)[index] == _vm.DataObj.value
	      },
	      on: {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-743a5874", module.exports)
	  }
	}
